...
\centering
\includegraphics[scale=0.5]{many_frames.eps}
...
\centering
\includegraphics[scale=0.5]{ssep_snr_tests.eps}
\caption{Implementation Signal Separation Performance with varying TX gain}
\end{figure}
