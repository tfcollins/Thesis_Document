...
\begin{figure}\label{Transmitter_System_Diagram}
\includegraphics{Transmitter.eps}
\end
...
\begin{figure}\label{Receiver_Block_Diagram}
\includegraphics{Receiver.eps}
\end
...
\includegraphics{eye_clean.eps}
\end{figure}

\begin{figure}\label{eye_closed}
\includegraphics{eye_closed.eps}
\end{figure}
...
\includegraphic{gnr_outline.eps}
\end
