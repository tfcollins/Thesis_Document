...
\begin{itemize}
\item A theoretical and simulated technique for non-orthoganol signal removal of undesired signals

\item A theoretical and simulated technique for residual signal removal, primarily manifested as frequency selective fading

\item A practical implementation using over the air communications of a anti-jamming sytem utilizing software defined radios. This implementation will tackle wideband non-orthoganol and orthoganol jamming, and provide evidence of performance under specificied channel conditions.
