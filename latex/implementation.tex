...
\begin{figure}
\includegraphics[scale=0.75]{sdr_block_diagram.eps}
\cite{sdr_blocks}
\end{figure}
...
\includegraphics{SS_Equalizer_sim.eps}
\end{figure} 
...
\includegraphics{ss_correlation_sim.eps}
\end{figure} 
...
\begin{figure}
\includegraphics{code_work_flow.eps}
\end{figure}
